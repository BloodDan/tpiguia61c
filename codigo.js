...
const API = 'https://retoolapi.dev/gdrN0Q/productos';
  ...
  function codigoCat(catstr) {
	...
	return code;
	  ...
	  var orden=0;
	  //Daniel Ernesto Guillen Morales - GM17027 - Grupo 07
	...
	function listarProductos(productos) {
	  ...
	  for(nfila=0;nfila<num;nfila++) {
		  try{
			...
			//Ingresando atributos al boton de "Eliminar productos"
	...
	function deleteProducto(ident) {
		fetch(`${API}/${ident}`,{method: "DELETE"})
			...
			alert(`Se ha eliminado el producto numero ${ident} satisfactoriamente`)
	}
	...
	//Metodos de ordenamiento en base al precio de forma ascendente y descendente
